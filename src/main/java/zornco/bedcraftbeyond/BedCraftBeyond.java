...
public class BedCraftBeyond {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		/** Blocks **/
		plankBlock = new BlockBCBPlanks().setHardness(2.0F).setResistance(5.0F).setUnlocalizedName("bcbwood");
		rugBlock = new BlockRug().setHardness(0.8F).setUnlocalizedName("rugBlock");
		bedBlock = new BlockColoredBed().setHardness(1.0f).setUnlocalizedName("CbedBlock");
		chestBedBlock = new BlockColoredChestBed().setHardness(1.0f).setUnlocalizedName("CCbedBlock");
		stoneBedBlock = new BlockStoneBed().setHardness(1.0f).setUnlocalizedName("SbedBlock");
