...
public class PlankHelperClient  implements IResourceManagerReloadListener{
	...
	public void fillColors() {
		for (String plank : PlankHelper.getPlankColorMap().keySet()) {
			...
			ItemStack stack2 =  new ItemStack((Item)(Item.itemRegistry.getObject(new ResourceLocation(plankSplit[0]))), 1, Integer.parseInt(plankSplit[1]));
