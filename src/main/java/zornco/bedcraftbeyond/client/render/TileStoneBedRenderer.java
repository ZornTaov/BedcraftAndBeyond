...
public class TileStoneBedRenderer extends TileEntitySpecialRenderer {
	...
	public void renderWorldBlock(TileEntity tile, IBlockAccess world, int i, int j, int k,
		...
		// TODO: int f = block.getMixedBrightnessForBlock(world, new BlockPos(i, j, k));
		...
		EnumFacing dir = block.getBedDirection(world.getBlockState(pos), world, pos);
		 ...
		 */
		this.stoneBedModel.render(null, (flag?1:0), 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
